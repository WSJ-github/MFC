...
// CTest11.4(String+int)View.cpp : CCTest114StringintView 类的实现
//
...
CCTest114StringintDoc* CCTest114StringintView::GetDocument() const // 非调试版本是内联的
{
