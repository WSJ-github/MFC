...
// CTest13.3(inputEllipseData).cpp : 定义应用程序的类行为。
//
...
// CCTest133inputEllipseDataApp 构造
...
// 唯一的一个 CCTest133inputEllipseDataApp 对象

CCTest133inputEllipseDataApp theApp;


// CCTest133inputEllipseDataApp 初始化
...
// CCTest133inputEllipseDataApp 消息处理程序
